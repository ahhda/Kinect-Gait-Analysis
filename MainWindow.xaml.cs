...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        List<int> kneeAngle = new List<int>();
        private int count = 0;
        private bool recording = false;
        private string textbox = "default";
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //plotter.
            //plotter.Pl(plotterPoints, Brushes.Red.Color, 2, "MyPlot");
        ...
        public double angle(Joint j1, Joint j2, Joint j3)
        {
            ...
            double angle1 = (180 / Math.PI) * (Math.Acos(cos));
            return angle1;
        }

        public double length(Joint j1, Joint j2)
        {
        ...
        private void start_rec(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                file2 = new System.IO.StreamWriter(filename2);
            }
            catch
            {
        ...
        //Stop Recording
        private void stop_rec(object sender, RoutedEventArgs e)
        {
            recording = false;
            try
            {
        ...
        private void Reset_Graph(object sender, RoutedEventArgs e)
        {
            plotter.Children.RemoveAll((typeof(LineGraph)));
            plotter.Children.RemoveAll((typeof(CirclePointMarker)));
            plotter2.Children.RemoveAll((typeof(LineGraph)));
            plotter2.Children.RemoveAll((typeof(CirclePointMarker)));
            count = 0;
            x.Clear();
            y.Clear();
            kneeAngle.Clear();
        ...
        private void save_graph(object sender, RoutedEventArgs e)
        {
            string s = textbox1.Text;
            string pic = "D:\\Files\\Kinect\\BodyBasics-WPF\\data\\" + s + ".jpg";
            plotter.SaveScreenshot(pic);
            string pic1 = "D:\\Files\\Kinect\\BodyBasics-WPF\\data\\" + s + "knee" + ".jpg";
            plotter2.SaveScreenshot(pic1);
        }

        private void TextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            
            this.textbox = textbox1.Text;
            filename = "D:\\Files\\Kinect\\BodyBasics-WPF\\data\\" + textbox + ".txt";
            filename2 = "D:\\Files\\Kinect\\BodyBasics-WPF\\data\\" + textbox + "knee" + ".txt";
        }
